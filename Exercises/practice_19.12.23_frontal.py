...
def can_enter_the_club(value):
    if value < 18:
        raise CustomErr("No children allowed")  # raising an error (in red) and crashing ...

    # or raise Exception("No children allowed")
    else:
        print("Enter! enjoy ... ")
...
try:
    ...
    can_enter_the_club(age)

except CustomErr:  # catching the error
    print(f"Try maybe an older kid?")
